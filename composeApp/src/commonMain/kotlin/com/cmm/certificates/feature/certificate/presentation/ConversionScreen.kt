...
import com.cmm.certificates.feature.certificate.presentation.components.PrimaryActionButton
import com.cmm.certificates.feature.certificate.presentation.components.SelectFileIcon
    ...
    AppTheme(darkTheme = false) {
        ConversionBottomBar(
            state = ConversionUiState(
                ...
                entries = listOf(
                    com.cmm.certificates.feature.certificate.domain.model.RegistrationEntry(
                        date = kotlinx.datetime.LocalDateTime(2026, 3, 26, 10, 0),
