package com.cmm.certificates.feature.settings.presentation.components
...
@Preview
@Composable
private fun SignatureSummaryCardPreview() {
    AppTheme {
        SignatureSummaryCard(
            signatureHtml = "<div style=\"font-family:Calibri; font-size:10pt;\"><div>Pagarbiai</div><div>Komanda</div></div>",
            onEdit = {},
        )
    }
}
