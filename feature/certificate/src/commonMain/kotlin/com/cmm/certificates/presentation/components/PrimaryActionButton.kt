...
import certificates.composeapp.generated.resources.common_format_pdf
...
@Preview
@Composable
private fun PrimaryActionButtonPreviewLight() {
    AppTheme(darkTheme = false) {
        PrimaryActionButton(text = "Convert", onClick = {})
    }
}
