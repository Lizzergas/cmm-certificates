...
@Composable
internal fun EmailProgressBottomBar(
            ...
            if (isInProgress) {
                ...
                if (cachedCount > 0) {
                    Button(
                        ...
                        Text(
                            text = stringResource(Res.string.email_progress_cached_send_button, cachedCount),
...
@Composable
internal fun EmailSuccessContent(
    modifier: Modifier,
    total: Int,
) {
...
private fun EmailRunningContentPreview() {
    AppTheme(darkTheme = true) {
        ProgressIndicatorContent(
            ...
            infoText = stringResource(Res.string.email_progress_recipient_label, "Ada <ada@example.com>"),
        )
    }
}
